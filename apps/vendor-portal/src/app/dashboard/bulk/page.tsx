            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-900 p-6">
                    ...
                    <button
                        ...
                        className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-indigo-600 py-2.5 font-medium text-white hover:bg-indigo-500 disabled:opacity-50"
                    >
                        {importing ? <Loader2 className="h-5 w-5 animate-spin" /> : 'Start Import'}
                    </button>
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-900 p-6">
                    <div className="mb-6 flex items-center gap-3">
                        ...
                        <h2 className="text-lg font-semibold text-white">Export Products</h2>
                    </div>

                    <p className="mb-6 text-sm text-slate-400">
                        Download your entire product catalog as a CSV file. The file will include
                        product details, SKUs, and characteristics.
                    </p>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-700 bg-slate-800 py-2.5 font-medium text-white transition-colors hover:bg-slate-700"
                    >
                        <DownloadCloud className="h-5 w-5" /> Export All Products
                    </a>
                </div>
            </div>
        </div>
