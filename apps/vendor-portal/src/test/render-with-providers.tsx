...
export const renderWithProviders = (view: React.ReactNode, searchParams = '') => {
    ...
    return { client, ...render(<NuqsTestingAdapter searchParams={searchParams}><QueryClientProvider client={client}><UiStoreProvider><ToastProvider>{view}</ToastProvider></UiStoreProvider></QueryClientProvider></NuqsTestingAdapter>) };
};
